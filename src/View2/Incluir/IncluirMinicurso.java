 ...
 * @author User
 */
public class IncluirMinicurso extends javax.swing.JInternalFrame {

    /**
     * Creates new form IncluirMinicurso
     */
    public IncluirMinicurso() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione", "Sob Avaliação", "Aprovado", "Reprovado" }));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
      ...
      try{
        ...
        String[] testeAutores = new String[2];
        String autores = jTextField3.getText();
   
        testeAutores = autores.split(",");
        
        minicurso.setTituloSubmissao(jTextField1.getText());
        minicurso.setAutoresSubmissao(testeAutores);
        minicurso.setResumo(jTextField4.getText());
        minicurso.setDuracao(Integer.parseInt(jTextField8.getText()));
