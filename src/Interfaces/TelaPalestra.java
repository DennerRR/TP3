...
public class TelaPalestra extends JPanel implements ActionListener {
	...
	private JLabel lCurriculo;
	private JTextField tCurriculo;
	...
	private JPanel j;
		...
		lIncluirArtigo = new JLabel("Incluir Palestras");
		...
		lCurriculo = new JLabel("Curriculo");
		lCurriculo.setBounds(310, 250, 350, 40);
		lCurriculo.setFont(new Font("Arial", Font.PLAIN, 20));
		lCurriculo.setForeground(new Color(128, 128, 128));
		add(lCurriculo);
		
		tCurriculo = new JTextField("");
		//tTitulo.setDocument(new Tratamento());
		tCurriculo.setBounds(390, 250, 200, 40);
		tCurriculo.setFont(new Font("Arial", Font.PLAIN, 20));
		tCurriculo.setForeground(new Color(92, 92, 92));
		add(tCurriculo);
		
		lDuracaco = new JLabel("Duração");
		lDuracaco.setBounds(20, 250, 350, 40);
		...
		//tTitulo.setDocument(new Tratamento());
		tDuracao.setBounds(100, 250, 200, 40);
