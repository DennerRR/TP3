...
public class TelaRelatorioTecnico extends JPanel implements ActionListener {
	...
	TelaRelatorioTecnico() {
				
		setBackground(Color.WHITE);
		setBounds(350, 0, 820, 768);
		setLayout(null);
		
		lIncluirArtigo = new JLabel("Incluir Relatórios");
		...
		lInstituicao = new JLabel("Instituição");
		...
		lNdePaginas = new JLabel("Número de páginas");
